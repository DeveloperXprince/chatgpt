...
async def chat(bot, message):
    ...
    try:
        ...
        if message.reply_to_message and message.reply_to_message.media:
            ...
            m = await message.reply_to_message.download(file_name="prince.mp3")
...
if SOURCE != s:
    print("So sad, you have changed source, change it back to ` https://github.com/DeveloperXprince/chatgpt `  else I won't work")
    sys.exit(1)  
